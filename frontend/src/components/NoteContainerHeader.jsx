            ...
            <form className="mx-auto my-2" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex">
                    ...
                    <div className="relative w-full">
                        <input type="search" id="searchText" {...register("searchText")} className="block p-2.5 w-full z-20 text-lg rounded-e-lg border-s-2 border focus:ring-blue-500  bg-gray-700 border-s-gray-700  border-gray-600 placeholder-gray-400 text-white focus:border-blue-500" placeholder="Search Notes..." required />
