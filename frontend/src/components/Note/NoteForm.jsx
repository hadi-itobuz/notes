...
const NoteForm = ({ setVisibility, type }) => {
    ...
    const onSubmit = data => {
        let method = (type.header === 'Edit') ? axiosInstance.put : axiosInstance.post;//setting custom method based on request type
        ...
        <>
            <form className="p-4 md:p-5" onSubmit={handleSubmit(onSubmit)}>
                <div className="grid gap-4 mb-4">
                    <div className="col-span-1"> {/*Title*/}
